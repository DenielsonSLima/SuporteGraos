-- ============================================================================
-- 📊 MIGRATION: Corrigir Projeção Inversa do Saldo Bancário no Dashboard
-- Data: 2026-04-12
-- Objetivo: A RPC projetava o saldo inicial para trás no gráfico "Evolução Patrimonial" 
-- como se o dinheiro já existisse 6 meses antes (se inserido hoje). 
-- Correção: Deduzir saldos iniciais configurados depois da data do snapshot.
-- ============================================================================
