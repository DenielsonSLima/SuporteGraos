-- ============================================================================
-- MIGRATION: 20260526204500_fix_dashboard_history_transit_and_cash.sql
-- Objetivo: Incluir 'emTransito' e 'saldoDisponivel' no histórico de patrimônio
--           líquido mensal da RPC rpc_dashboard_data para que o frontend possa
--           exibir as novas colunas/empilhamentos no gráfico de evolução patrimonial.
-- ============================================================================
