  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-md p-4 animate-in fade-in">
        <div className="w-full max-w-xl bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/20 animate-in zoom-in-95 duration-300">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="bg-amber-50/50 p-6 rounded-[2rem] border border-amber-100">
              ...
              <div className="relative">
                ...
                <input type="text" value={displayDiscount} onChange={handleDiscountChange} className={`${inputClass} pl-12 border-amber-50 text-amber-700 focus:border-amber-500`} placeholder="R$ 0,00" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select required={numericAmount > 0} value={accountId} onChange={e => setAccountId(e.target.value)} className={`${inputClass} pl-12 appearance-none`}>
