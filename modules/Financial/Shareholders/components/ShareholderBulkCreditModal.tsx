...
const ShareholderBulkCreditModal: React.FC<Props> = ({ isOpen, onClose, shareholders, onProcessTransaction }) => {
  ...
  const confirmPayment = () => {
    ...
    onProcessTransaction('payment', { shareholderId: payingShareholderId, date: globalDate, value: val, description: globalDescription, accountId: selectedAccountId, accountName: account?.account_name });
