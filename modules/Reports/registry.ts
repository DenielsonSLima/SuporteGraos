...
export const REPORT_METADATA = [
  ...
  { id: 'transfers_report', category: 'financial' as const, order: 5 },
  { id: 'loans_report', category: 'financial' as const, order: 6 },
  { id: 'advances_report', category: 'financial' as const, order: 7 },
  { id: 'expenses_detailed', category: 'financial' as const, order: 8 },
  { id: 'shareholders_report', category: 'financial' as const, order: 9 },
...
export const getReportById = async (id: string): Promise<ReportModule | undefined> => {
  ...
  try {
    ...
    console.error(`Erro ao carregar relatório ${id}:`, error);
    return undefined;
  }
};
